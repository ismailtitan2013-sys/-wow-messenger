              ...
              <div style={{ padding: '10px 5px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
                  {(storeData?.nfts && Array.isArray(storeData.nfts) ? [...customNfts, ...storeData.nfts] : [
                    ...
                    { id: 'nft_tg_spotty', serial: '#777', name: 'Telegram Spotty Dog', rarity: 'Legendary', price: 500000, imageUrl: 'https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=400&auto=format&fit=crop&q=80', desc: 'Легендарный пес Spotty — официальный символ Telegram' },
                    { id: 'nft_tg_box', serial: '#999', name: 'Telegram Golden Gift Box', rarity: 'Mythic', price: 1000000, imageUrl: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=400&auto=format&fit=crop&q=80', desc: 'Золотая коллекционная коробка подарков Telegram' },
                    { id: 'nft_tg_whale', serial: '#888', name: 'Telegram TON Whale', rarity: 'Mythic', price: 3000000, imageUrl: 'https://images.unsplash.com/photo-1568430460464-02e1dc61e927?w=400&auto=format&fit=crop&q=80', desc: 'Эксклюзивный кит блокчейна TON из Telegram' },
                    { id: 'nft_gold_mask', serial: '#111', name: 'Golden Sheikh Mask', rarity: 'Legendary', price: 2500000, imageUrl: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=400&auto=format&fit=crop&q=80', desc: 'Маска Золотого Шейха из чистого золота 999 пробы' },
                    { id: 'nft_diamond_crown', serial: '#007', name: 'Imperial Diamond Crown', rarity: 'Mythic', price: 5000000, imageUrl: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=400&auto=format&fit=crop&q=80', desc: 'Императорская корона с 1000 редких алмазов' },
                    { id: 'nft_emerald_ring', serial: '#777', name: 'Cyber Emerald Ring', rarity: 'Mythic', price: 10000000, imageUrl: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&auto=format&fit=crop&q=80', desc: 'Ультра-эксклюзивный перстень с гигантским изумрудом' },
                    { id: 'nft_dragon', serial: '#001', name: 'Cosmic Falcon', rarity: 'Rare', price: 1500, imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=400&auto=format&fit=crop&q=80', desc: 'Быстрый Космический Сокол' },
                    { id: 'nft_panther', serial: '#002', name: 'Cyber Panther', rarity: 'Epic', price: 2500, imageUrl: 'https://images.unsplash.com/photo-1534188753412-3e26d0d618d6?w=400&auto=format&fit=crop&q=80', desc: 'Кибернетическая Пантера будущего' },
                    { id: 'nft_crown', serial: '#003', name: 'Empire Crown', rarity: 'Legendary', price: 5000, imageUrl: 'https://images.unsplash.com/photo-1589128777073-263566ae5e4d?w=400&auto=format&fit=crop&q=80', desc: 'Императорская Корона Мецената' },
                    { id: 'nft_portal', serial: '#004', name: 'Galactic Portal', rarity: 'Mythic', price: 10000, imageUrl: 'https://images.unsplash.com/photo-1506703719100-a0f3a48c0f86?w=400&auto=format&fit=crop&q=80', desc: 'Портал в Галактическую Вселенную' }
