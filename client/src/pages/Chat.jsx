            ...
            {activeStoreTab === 'nfts' && (
              <div style={{ padding: '10px 5px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
                  {[...customNfts, ...[
                    { id: 'nft_bored_ape_8814', serial: '#8814', name: 'Bored Ape BAYC #8814', rarity: 'Mythic', price: 2500000, imageUrl: './assets/nfts/bored_ape.jpg', desc: 'Официальный 3D аватар Bored Ape Yacht Club BAYC #8814' },
                    { id: 'nft_pudgy_1204', serial: '#1204', name: 'Pudgy Penguin #1204', rarity: 'Legendary', price: 1500000, imageUrl: './assets/nfts/pudgy_penguin.jpg', desc: 'Эксклюзивный 3D пингвин из коллекции OpenSea Pudgy Penguins' },
                    { id: 'nft_azuki_9910', serial: '#9910', name: 'Azuki Anime #9910', rarity: 'Mythic', price: 3000000, imageUrl: './assets/nfts/azuki.jpg', desc: 'Официальная аниме NFT карточка с самурайским мечом из коллекции Azuki' },
