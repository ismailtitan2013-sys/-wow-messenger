            ...
            {activeStoreTab === 'nfts' && (
              <div style={{ padding: '10px 5px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
                  {[...customNfts, ...[
                    { id: 'nft_bored_ape_8814', serial: '#8814', name: 'Bored Ape BAYC #8814', rarity: 'Mythic', price: 2500000, imageUrl: 'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=500&auto=format&fit=crop&q=80', desc: 'Официальный карточный NFT из коллекции OpenSea BAYC' },
                    { id: 'nft_pudgy_1204', serial: '#1204', name: 'Pudgy Penguin #1204', rarity: 'Legendary', price: 1500000, imageUrl: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=500&auto=format&fit=crop&q=80', desc: 'Эксклюзивный пингвин из коллекции OpenSea Pudgy Penguins' },
                    { id: 'nft_azuki_9910', serial: '#9910', name: 'Azuki Anime #9910', rarity: 'Mythic', price: 3000000, imageUrl: 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=500&auto=format&fit=crop&q=80', desc: 'Аниме NFT карточка из официальной коллекции Azuki' },
                    { id: 'nft_faith_amulet_24949', serial: '#24949', name: 'Faith Symbol', rarity: 'Mythic', price: 1000000, imageUrl: 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=500&auto=format&fit=crop&q=80', desc: 'Священный Значок Веры "Velvet Dusk"' },
                    { id: 'nft_tg_star_gift', serial: '#001', name: 'Telegram Star Gift', rarity: 'Rare', price: 50000, imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=500&auto=format&fit=crop&q=80', desc: 'Официальный коллекционный подарок Telegram Star' },
                    { id: 'nft_tg_pepe', serial: '#420', name: 'Telegram Cyber Pepe', rarity: 'Epic', price: 250000, imageUrl: 'https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=500&auto=format&fit=crop&q=80', desc: 'Редчайший коллекционный Pepe Gift из Telegram' },
                    { id: 'nft_tg_spotty', serial: '#777', name: 'Telegram Spotty Dog', rarity: 'Legendary', price: 500000, imageUrl: 'https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=500&auto=format&fit=crop&q=80', desc: 'Легендарный пес Spotty — официальный символ Telegram' },
                    { id: 'nft_tg_box', serial: '#999', name: 'Telegram Golden Gift Box', rarity: 'Mythic', price: 1000000, imageUrl: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=500&auto=format&fit=crop&q=80', desc: 'Золотая коллекционная коробка подарков Telegram' },
                    { id: 'nft_tg_whale', serial: '#888', name: 'Telegram TON Whale', rarity: 'Mythic', price: 3000000, imageUrl: 'https://images.unsplash.com/photo-1568430460464-02e1dc61e927?w=500&auto=format&fit=crop&q=80', desc: 'Эксклюзивный кит блокчейна TON из Telegram' },
                    { id: 'nft_gold_mask', serial: '#111', name: 'Golden Sheikh Mask', rarity: 'Legendary', price: 2500000, imageUrl: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=500&auto=format&fit=crop&q=80', desc: 'Маска Золотого Шейха из чистого золота 999 пробы' },
                    { id: 'nft_diamond_crown', serial: '#007', name: 'Imperial Diamond Crown', rarity: 'Mythic', price: 5000000, imageUrl: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=500&auto=format&fit=crop&q=80', desc: 'Императорская корона с 1000 редких алмазов' },
                    { id: 'nft_emerald_ring', serial: '#777', name: 'Cyber Emerald Ring', rarity: 'Mythic', price: 10000000, imageUrl: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=500&auto=format&fit=crop&q=80', desc: 'Ультра-эксклюзивный перстень с гигантским изумрудом' }
